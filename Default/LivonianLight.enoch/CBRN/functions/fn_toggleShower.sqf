...
if (_on) then {
    ...
    _trg setTriggerStatements ["ace_player getVariable ['cbrn_autoDamage', false] && { !(ace_player getVariable ['cbrn_stoppedAutoDamage', false]) && {ace_player in thisList}}", "ace_player setVariable ['cbrn_stoppedAutoDamage', true]; 'Sukces!' hintC 'Udało się zmyć promieniotwórczy osad'", ""];
