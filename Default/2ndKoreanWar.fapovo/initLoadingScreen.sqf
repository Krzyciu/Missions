...
_text ctrlCommit 0;
_text ctrlSetText localize "STR_Mission_Loading_Screen";



_text3 = _display ctrlCreate ["RscStructuredText", -1];
_text3 ctrlSetPosition [safeZoneX, safeZoneH + safeZoneY - (20 * pixelH * (getResolution#4)),1, (20 * pixelH * (getResolution#4))];
_text3 ctrlCommit 0;
_text3 ctrlSetStructuredText parseText "<t color='#FFFFFF' size='1' align='left'>by </t><t color='#FFFFFF' size='1.1' align='left'>A3C|Krzyciu</t>";
