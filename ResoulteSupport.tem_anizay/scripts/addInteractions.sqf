  ...
  [QGVAR(rescueCrew), LLSTRING(Action_rescueCrew), "", {
    ...
    [
      ...
      [0],
      {
          ...
          ["med", 1, crew_1] spawn FUNC(damageUnit);
          deleteVehicle wreck;
      },
      {
...
[
  ...
  0,
  [],
  [QGVAR(elder), LLSTRING(Action_TalkToElder), "", {
    params ["_target"];
    _target spawn FUNC(elderTalk);
  }, {_target getVariable [QGVAR(elderTalked), true]}, {}, [], [0,0,0.5], 5] call ACEFUNC(interact_menu,createAction)
] call ACEFUNC(interact_menu,addActionToClass);
